	...
	if(have_posts()) : while (have_posts()) : the_post();
...

		{
			...
			$output .= '<ul class="comment_box clearfix">';
							...
							var_dump($show_post_comments_box);
		...
		$output .= '			<a href="' . get_comments_link() . '" title="' . $comments_count . ' ' . ($comments_count==1 ? __('commentaire', 'medicenter') : __('commentaires', 'medicenter')) . '">' . $comments_count . ((int)$show_post_comments_label ? ' ' . ($comments_count==1 ? __('commentaire', 'medicenter') : __('commentaires', 'medicenter')) : '') . '</a>
...

			{
				...
				if($images_count>0)		
					...
					$output .= '<a class="thumb_image" href="' . get_permalink() . '" title="' . get_the_title() . '">' . wp_get_attachment_image((int)$attachment_ids[0], ($featured_image_size!="default" ? $featured_image_size : $themename . "-small-thumb"), array("alt "=> get_the_title(), "title" => "")) . '</a>';	
						...
						$output .= apply_filters('the_excerpt', get_the_excerpt() . ((int)$read_more && (int)$layout_type==3 ? '<a title="' . __('En savoir plus', 'medicenter') . '" href="' . get_permalink() . '" class="more">' . __('En savoir plus &rarr;', 'medicenter') . '</a>' : ''));
						...
						if((int)$layout_type==3)
							...
							if((int)$read_more && (int)$layout_type!=3)
								...
								$output .= '<a title="' . __('En savoir plus', 'medicenter') . '" href="' . get_permalink() . '" class="more">' . __('En savoir plus &rarr;', 'medicenter') . '</a>';
		...
		$output .= '		<div class="post_footer clearfix">';
								...
								$output .= '<ul class="post_footer_details">';
									...
									$output .= '<li>' . __('Posté dans', 'medicenter') . '</li>';
		...
		$output .= '			</ul>';
								...
								$output .= '<ul class="post_footer_details">
									...
									<li>' . __('Posté dans', 'medicenter') . '</li>
								...
								$output .= '<ul class="post_footer_details">
									...
									<li>
										...
										' . __('Commentaires:', 'medicenter') . ' <a href="' . get_comments_link() . '" title="' . $comments_count . ' ' . ($comments_count==1 ? __('commentaire', 'medicenter') : __('commentaires', 'medicenter')) . '">' . $comments_count . '</a>
