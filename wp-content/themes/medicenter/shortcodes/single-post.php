...

{
	...
	$output .= wpb_js_remove_wpautop(apply_filters('the_content', get_the_content()));
...

					{
						...
						$output .= '<a title="' . __('Laisser une réponse', 'medicenter') . '" href="#comment_form" class="more reply_button">'

							. __('Laisser une réponse &rarr;', 'medicenter') . '
						...
						$output .= '<ul class="post_footer_details">';
...

							{
								...
								if(empty($category->description))
									...
									$output .= 'title="' . sprintf(__('Voir tout les articles %s', 'medicenter'), $category->name) . '"';
	...
	wpb_map( array(
		...
		"params" => array(
			...
			array(
				...
				"heading" => __("Commentaires", 'medicenter'),
