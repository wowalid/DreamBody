...
class home_box_widget extends WP_Widget 
{
    ...
    function update($new_instance, $old_instance) 
	{
		...
		$instance['animation_duration'] = strip_tags($new_instance['animation_duration']);
		$instance['animation_delay'] = strip_tags($new_instance['animation_delay']);
	...
	{	
		...
		$animation_duration = esc_attr($instance['animation_duration']);
